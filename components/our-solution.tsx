    ...
    <section id="technology" className="relative h-screen before:absolute before:inset-0 before:-z-20 before:bg-green-50 flex flex-col justify-center">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Grid */}
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-green-200 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:4px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-4px] [&>*]:after:absolute [&>*]:after:bg-green-200 [&>*]:after:[block-size:4px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-4px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-green-900">
                <svg
                ...
                <span>Biological Filtration</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Using algae biofilters to remove pollutants from wastewater.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-green-900">
                ...
                <span>Electricity Side Effect</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Producing electricity as a byproduct of the filtration process.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-green-900">
